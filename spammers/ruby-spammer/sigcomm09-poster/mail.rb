...
list = MailList.new("mail-invite.txt", "invitation.txt")
  list.send("Nick Feamster <feamster@cc.gatech.edu>",
	    "Invitation to Sigcomm 2009 Poster/Demo PC",
	    "Nick Feamster <feamster@cc.gatech.edu>, Renata Teixeira <renata.teixeira@lip6.fr>")
