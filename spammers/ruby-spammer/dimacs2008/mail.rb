...
list = MailList.new("dimacs-invite.txt", "dimacs.txt")
  list.send("Nick Feamster <feamster@cc.gatech.edu>",
	    "Invitation to Participate: DIMACS Workshop",
	    "Rebecca Wright <rebecca.wright@rutgers.edu>, Linda Casals <lindac@dimacs.rutgers.edu>, Steve Bellovin <smb@cs.columbia.edu>, Nicole Clark <nicolec@dimacs.rutgers.edu>, Vijay Ramachandran <vramachandran@mail.colgate.edu>")
