...
list = MailList.new("censorship-invitees.txt", "invitation-letter.txt")
  list.send("Nick Feamster <feamster@cc.gatech.edu>",
	    "Invitation to Workshop on Free and Open Communication on the Internet",
	    "Mary Claire Thompson <thompson@cc.gatech.edu>, Nick Feamster <feamster@cc.gatech.edu>")
