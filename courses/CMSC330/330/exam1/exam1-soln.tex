...
\begin{document}
  ...
  \header{\course}{Exam \#1 solutions}{\Term}
  ...
  \begin{enumerate}
    ...
    \item {[30 pts.]} Different solutions are obviously possible.  The first
          ...
          \VerbatimInput[gobble=0,baselinestretch=.9]{most-occurrences.rb}

          \medskip

          \enlargethispage{8mm}

          \VerbatimInput[gobble=0,baselinestretch=.9]{most-occurrences2.rb}
