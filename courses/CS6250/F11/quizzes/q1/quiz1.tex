...
their relationships.
\begin{center}
\resizebox{0.5\textwidth}{!}{\includegraphics{bgp-as}}
\end{center}
\setcounter{partctr}{0}
\begin{list}{\bf\Alph{partctr}.}{\usecounter{partctr}}
...
%\item Describe a scenario involving ``backplane peering'' where $P2$ might
%  readvertise some of the routes that it learned from $P1$ to
%  $P3$. State specifically which set of routes it might readvertise. 
\end{list}
~\ansbelow 
...
second. 
\begin{center}
\resizebox{0.5\textwidth}{!}{\includegraphics{backplane}}
\end{center}
\setcounter{partctr}{0}
\begin{list}{\bf\Alph{partctr}.}{\usecounter{partctr}}
...
period.   
\begin{center}
\resizebox{0.5\textwidth}{!}{\includegraphics{isis-cdf}}
\end{center}
\setcounter{partctr}{0}
\begin{list}{\bf\Alph{partctr}.}{\usecounter{partctr}}
...
an access link.  
\begin{center}
\resizebox{0.75\textwidth}{!}{\includegraphics{netalyzr-buffer}}
\end{center}
\setcounter{partctr}{0}
\begin{list}{\bf\Alph{partctr}.}{\usecounter{partctr}}
...
Netalyzr tool.   
\begin{center}
\resizebox{0.75\textwidth}{!}{\includegraphics{netalyzr-traceroute}}
\end{center}
\setcounter{partctr}{0}
\begin{list}{\bf\Alph{partctr}.}{\usecounter{partctr}}
