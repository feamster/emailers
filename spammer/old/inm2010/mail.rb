...
list = MailList.new("inm-invite2.txt", "inm-letter2.txt")
  list.send("Nick Feamster <feamster@cc.gatech.edu>",
	    "Invitation to USENIX Internet Network Management Workshop (INM)",
	    "Aditya Akella <akella@cs.wisc.edu>, Nick Feamster <feamster@cc.gatech.edu>, Sanjay Rao <sanjay@ecn.purdue.edu>")
