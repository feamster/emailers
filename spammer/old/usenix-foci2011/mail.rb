...
list = MailList.new("invite-list.txt", "letter.txt")
  list.send("Nick Feamster <feamster@cc.gatech.edu>",
	    "Invitation to Program Committee for USENIX Workshop on Free and Open Communication on the Internet",
	    "Wenke Lee <wenke@cc.gatech.edu>, Nick Feamster <feamster@cc.gatech.edu>")
