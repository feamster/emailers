...
list = MailList.new("invitees.txt", "letter.txt")
  list.send("Nick Feamster <feamster@cc.gatech.edu>",
	    "Invitation to PC for SIGCOMM Workshop on Software Defined Networking",
	    "Jennifer Rexford <jrex@cs.princeton.edu>, Nick Feamster <feamster@cc.gatech.edu>")
