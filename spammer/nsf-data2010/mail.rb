...
list = MailList.new("invite5.txt", "invite-letter.txt")
  list.send("Nick Feamster <feamster@cc.gatech.edu>",
	    "Invitation to NSF Workshop on Cybersecurity Data for Experimentation",
	    "Xiaoyang Sean Wang <xwang@nsf.gov>, Lenore Zuck <lzuck@nsf.gov>, Mary Claire Thompson <thompson@cc.gatech.edu>, Nick Feamster <feamster@cc.gatech.edu>")
